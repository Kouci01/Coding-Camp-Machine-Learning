...
class handDetector:
    ...
    detection_confident= 0.5, tracking_confident=0.5):
        ...
        self.hands = self.mphands.Hands(static_image_mode = self.static_mode,max_num_hands = self.maxhands, min_detection_confidence = self.detection_confident, min_tracking_confidence = self.tracking_confident)
